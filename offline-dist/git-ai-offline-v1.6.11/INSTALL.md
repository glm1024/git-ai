...
适用范围：研发内网 Linux、Windows，以及 VS Code、Cursor、JetBrains IDE。
...
git-ai-offline-v1.6.11/
  ...
  vscode/
    git-ai.git-ai-vscode-0.1.21.vsix
  jetbrains/
    Git_AI-0.1.12.zip
```
...
- VS Code 和 Cursor：`vscode/git-ai.git-ai-vscode-0.1.21.vsix`
...
```bash
cd /path/to/git-ai-offline-v1.6.11
uname -m
```
...
```powershell
cd C:\path\to\git-ai-offline-v1.6.11
